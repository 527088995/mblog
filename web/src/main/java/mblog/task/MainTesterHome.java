 ...
 * @date 2017/02/09
 */
public class MainTesterHome {

    //需要进行爬取得博客首页q1
//	private static final String URL = "http://blog.csdn.net/guolin_blog";
    private static final String URL1 = "https://testerhome.com/topics/last";
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection conn = Jsoup.connect(String.valueOf(realUrl))	//博客首页的url地址
